...
def __duplicate_str__(duplicate_df):

    if duplicate_df.empty == False:
        duplicado_str = '!#ERROR#! O Laudo possui amostras repetidas, por favor, verificar e corrigir'
    else:
        duplicado_str = ''

    return duplicado_str
